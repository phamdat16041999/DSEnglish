...
/*-----------------------------
      ...
      $('#start-record-btn').on('click', function(e) {
        ...
        document.getElementById('pause-record-btn').style.display = "initial"
      ...
      $('#pause-record-btn').on('click', function(e) {
        ...
        document.getElementById('start-record-btn').style.display = "initial"
